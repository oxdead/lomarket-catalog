...
class ControllerStartupStartup extends Controller {
	public function index() {
		...
		if (isset($this->session->data['shipping_address']) && $this->session->data['shipping_address']
			&& isset($this->session->data['shipping_address']['country_id']) && $this->session->data['shipping_address']['country_id']
		...
		if (isset($this->session->data['payment_address']) && $this->session->data['payment_address']
			&& isset($this->session->data['payment_address']['country_id']) && $this->session->data['payment_address']['country_id']
			&& isset($this->session->data['payment_address']['zone_id']) && $this->session->data['payment_address']['zone_id']
		) {
